...
%defining ak for 1b
yak1 = [y1 y2 y3 y4 y5 y6 y7 y8 y9 y10 y11];
...
%defining time 
t_1 = [t1 t010 t2 t20 t3 t30 t4 t40 t5 t50 t6 t60 t7 t70 t8 t80 t9 t90 t10 tA0 t11 tB0];
...
%defining ak
ym = [y1 Y10 y2 Y20 y3 Y30 y4 Y40 y5 Y50 y6 Y60 y7 Y70 y8 Y80 y9 Y90 y10 YA0 y11 YB0];

%plotting of ak
subplot(5,1,4);
plot(t_1 ,ym);  
ylim([-1.5 1.5]);
title(" message signal for 1a");
xlabel("time(sec)");
ylabel("Amplitude(Volt)");
grid on;
...
%defining ak
ym2 = [y1 Y10 y2 Y20 y3 Y30 y4 Y40 y5 Y50 y6 Y60 y7 Y70 y8 Y80 y9 Y90 y10 YA0 y11 YB0];

%plotting of ak
subplot(5,1,5);
plot(t_1 ,ym2); 
ylim([-1.5 1.5]);
title(" message signal for 1b");
xlabel("time(sec)");
ylabel("Amplitude(Volt)");
grid on; 
